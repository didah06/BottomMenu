    ...
    public void onBindViewHolder(@NonNull HolderIhram holder, int position) {
        ...
        holder.setClickListener(new ItemClickListener() {
            ...
            public void onItemClickListener(View v, int position) {
                if (ihramModel.get(position).getTitle().equals("Apa itu Maqom Ibrahim")) {
                    Intent jelas = new Intent(context, ApaMaqomIbrahim.class);
                    context.startActivity(jelas);
                }
                if (ihramModel.get(position).getTitle().equals("Kesalahan-kesalahan")) {
                    Intent in = new Intent(context, Kesalahan_Maqom.class);
